...
# Function to load data based on file type (CSV/JSON)
def load_utility_data(file_path, file_type="csv"):
    if file_type == "csv":
...
# Example of data paths for each utility
utility_paths = {
    "utility1": {
...
def silver_layer_standardization(bronze_data):
    ...
    for utility, datasets in bronze_data.items():
        ...
        # Similar standardization can be applied for installed and planned DER data
